(function () {
	...
	.controller('EmployeeDashBoardModalCtrl', EmployeeDashBoardModalCtrl);

    /** @ngInject */
    function EmployeeDashBoardModalCtrl($scope, $state,$uibModalInstance, appUtils, reportType, reportData) {
        ...
        $scope.getRegion = $scope.editEmployeeVm.getRegion;
