(function () {
    ...
    angular.module('app.employee')
        .controller('uploadFileAppHistoryController', uploadFileAppHistoryController);

    /** @ngInject */
    function uploadFileAppHistoryController($scope, $q, $timeout, $state, authService, appUtils, BaseEmployeLogClass, employeeService) {
        ...
        function initPage() {
            logingProvider.initPage().then(function () {
                ...
                employeeHistoryVm.allTerritories = parent.allTerritories || [];
                employeeHistoryVm.allStates = parent.appStatelist || [];
            });
        }
