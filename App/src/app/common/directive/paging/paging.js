    ...
    angular.module('app.Directive.Paging', []).directive('listPaging', ['$parse', function($parse) {
        return {
            ...
            template: ['<div class="">',
                ...
                '<a href="#" ng-click="prevPage();" class="btn btn-sm default prev" ng-class="{disabled: curPage == 1}"><span class="fa fa-angle-left"></span></a>',
                ...
                '<a href="#" ng-click="nextPage();" class="btn btn-sm default next" ng-class="{disabled: curPage == data.totalPage}"><span class="fa fa-angle-right"></span></a>',
